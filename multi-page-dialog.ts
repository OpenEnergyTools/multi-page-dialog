...
@customElement('multi-page-dialog')
/** Slottable (multi page) dialog */
export class MultiPageDialog extends LitElement {
  ...
  private get prevPage(): MultiPageDialog | null {
    if (this.previousElementSibling instanceof MultiPageDialog)
      return this.previousElementSibling as MultiPageDialog;

    return null;
  }

  private get nextPage(): MultiPageDialog | null {
    if (this.nextElementSibling instanceof MultiPageDialog)
      return this.nextElementSibling as MultiPageDialog;
